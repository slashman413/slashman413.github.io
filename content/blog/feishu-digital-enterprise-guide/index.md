...
<div style="background: rgba(0, 194, 199, 0.1); border: 1px solid rgba(0, 194, 199, 0.3); border-radius: 12px; padding: 1.5rem; margin: 2rem 0;">
  ...
  <p><a href="https://slashmaster6.gumroad.com/l/xohjh?utm_source=blog&utm_medium=seo&utm_campaign=xohjh" target="_blank" rel="noopener" style="display: inline-block; background: #00C2C7; color: #090D16; padding: 0.75rem 1.5rem; border-radius: 8px; font-weight: 700; text-decoration: none;">立即取得 飛書自動化模板套組 ($49) →</a></p>
</div>
